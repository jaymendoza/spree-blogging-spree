...
Development is in its early stages, containing only a simple blog and a jQuery-powered news archive widget. See the tracker[http://github.com/jaymendoza/spree-blogging-spree/issues] for future plans.
